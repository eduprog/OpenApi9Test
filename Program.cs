...
/*
 *
 * PARA ACESSAR A DOCUMENTAÇÃO SWAGGER, UTILIZE O SEGUINTE ENDEREÇO:
 *    https://localhost:[porta]/swagger/controllers
 *    https://localhost:[porta]/swagger/responses
 *    https://localhost:[porta]/swagger/forms
 *    https://localhost:[porta]/swagger/schemas-by-ref
 *
 *    BEM INTERESSANTE PARA QUEBRARMOS A DOCUMENTAÇÃO EM PARTES E NÃO FICAR TUDO MISTURADO
 *
 */
...
schemas.MapGet("/product", ([FromBody] Product product) => TypedResults.Ok(product));
schemas.MapGet("/account", ([FromBody] Account account) => TypedResults.Ok(account));
